...
export const projects = [
  {
    ...
    features: "Animated Transitions, Modern UI, Responsive",
    tag: ["Team Project"],
...

  {
    ...
    features: "CRUD operations (SignIn / SignOut / Register), UI changes based on login status, Responsive",
  ...
  },
  {
    ...
    features: "Modal Video Player, Modern UI, Responsive",
    tag: ["Online Tutorial"],
