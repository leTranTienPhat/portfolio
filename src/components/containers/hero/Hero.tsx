    ...
    <div className="hero-container">
      <div className="hero">
        ...
        {/* <div className="bio-wrapper">
          ...
          <p className="bio-important-info">I have been self-studing Javascript, ReactJS, NextJS for 4 months, did some small projects here and there to put my knowledge into practice.
          </p>
        </div> */}
      </div>
    </div>
